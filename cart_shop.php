...
if(isset($_POST['update_update_btn'])){
   ...
   $update_quantity_query = pg_query($conn, "UPDATE cart SET quantity = '$update_value' WHERE cid = '$update_id'");
...
if(isset($_GET['remove'])){
   ...
   pg_query($conn, "DELETE FROM cart WHERE id = '$remove_id'");
   header('location:cart.php');
};

if(isset($_GET['delete_all'])){
   pg_query($conn, "DELETE FROM cart");
   header('location:cart.php');
}
